...
# Configuracoes:
$veracodeID = "ID da Veracode obtido do portal"
$veracodeAPIkey = "API Key da Veracode obtido do portal" 
$NomeApp = "Um identificador para o projeto"
$caminho = "Caminho do arquivo que vai ser executado"
